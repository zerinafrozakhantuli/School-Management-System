...
<div class="row">
<div class="col-md-12 ">
<form method="post" action="{{url('dashboard/classlist/update')}}">
  @csrf
<div class="card mb-3">
  <div class="card-header">
    <div class="row">
        <div class="col-md-8 card_title_part">
            <i class="fab fa-gg-circle"></i>Edit Class List
        </div>  
  ...
  <div class="card-body">
    ...
    <div class="col-md-2"></div>
      ...
      <div class="row mb-3 {{ $errors->has('name') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-7">
          <input type="hidden" name="id" value="{{$edit->clslist_id}}">
          <input type="text" class="form-control form_control" id="" name="name" value="{{$edit->clslist_name}}">
        @if($errors->has('name'))
      ...
      <div class="row mb-3 {{ $errors->has('summary') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-7">
          <textarea type="text" class="form-control form_control" id="" name="summary">{{$edit->clslist_summary}}</textarea>
